...
* Commands to execute to perform specific tasks such as compiling and packaging code using the tools mentioned above.
...
To use the above devfile it is possible to simple go to the DevSpaces web UI and paste the URL for the Git repository given above. This will be done in the next chapter.
