...
The operator installation will then take place, which may take a minute or two to complete. When it has completed the screen will show that it has installed correctly. 

*Click the blue button to 'View operator' as shown below.*
...
*Don't scroll down and hit 'Create' straight away - there is some configuration to do.*
...
The result of installing the DevSpaces operator is that two operators are added to the platform as shown below. To view the summary as shown below click on the *Ecosystem* menu item on the left hand side and then select the *Installed Operators* menu.
