...
In the previous section you explored the workspace. Since this exercise uses the same workspace you will do different tasks involving using tasks to run the application code and interacting with the running application.
