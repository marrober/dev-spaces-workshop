...
The link below is a custom link to launch DevSpaces in your personal cluster against the devfile in the repository mentioned above.
...
[source,bash,subs="+attributes"]
----
https://devspaces.%CLUSTER_SUBDOMAIN%/dashboard/#/load-factory?url=https://github.com/marrober/pacman.git
----
...
The dependency download will then run in the terminal window and the output will be displayed. 

When you have ready anything that you need from the terminal window click into it and press any key to dismiss the results.

If you need multiple terminal windows then click on the + sign on the top right of the terminal window area as shown below. Multiple terminals can be displayed in a variety of configurations including side-by-side to enable you to operate in different directories without constants changing directory of a single terminal.

image::terminal-completion-window.png[terminal completion window, width=1000px, align="centre"]
