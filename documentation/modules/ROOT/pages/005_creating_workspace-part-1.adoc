...
The first time you launch the Dev Spaces web UI you will be asked to authenticate with your username and password. For the workshop your username is 'cluster-admin' and the password is available on the workshop launcher app.
